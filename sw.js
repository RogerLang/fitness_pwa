const SHELL_CACHE = "fitness-pwa-shell-v91";
const SHELL_ASSETS = [
  "./",
  "./index.html",
  "./rescue.html",
  ...
  "./js/training/training-draft.js?v=91",
  "./js/training/training-render.js?v=91",
  "./js/training/training-insights.js?v=72",
  "./js/training/training-maintenance.js?v=72",
  "./js/training/training.js?v=91",
  "./js/training/planning.js?v=91",
